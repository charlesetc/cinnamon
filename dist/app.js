...
(function($PS) {
  ...
  "use strict";
  $PS["App.Data.Types"] = $PS["App.Data.Types"] || {};
  var exports = $PS["App.Data.Types"];                     
  var Halogen = (function () {
      function Halogen() {

      };
      Halogen.value = new Halogen();
      return Halogen;
  })();
  var React = (function () {
      function React() {
      ...
      React.value = new React();
      return React;
  })();
  var ReactBasic = (function () {
      function ReactBasic() {

      };
      ReactBasic.value = new ReactBasic();
      return ReactBasic;
  })();
  var SomethingElse = (function () {
      ...
      SomethingElse.value = new SomethingElse();
      return SomethingElse;
  })();
  var showFramework = {
      show: function (v) {
          if (v instanceof Halogen) {
              return "Halogen";
          };
          if (v instanceof React) {
              return "React";
          };
          if (v instanceof ReactBasic) {
              return "React Basic";
          };
          if (v instanceof SomethingElse) {
              return "Something Else";
          };
          throw new Error("Failed pattern match at App.Data.Types (line 14, column 10 - line 18, column 38): " + [ v.constructor.name ]);
      }
  };
  var eqFramework = {
      eq: function (x) {
          return function (y) {
              if (x instanceof Halogen && y instanceof Halogen) {
                  return true;
              };
              if (x instanceof React && y instanceof React) {
                  return true;
              };
              if (x instanceof ReactBasic && y instanceof ReactBasic) {
                  return true;
              };
              if (x instanceof SomethingElse && y instanceof SomethingElse) {
                  return true;
              };
              return false;
          };
  ...
  exports["Halogen"] = Halogen;
  exports["React"] = React;
  exports["ReactBasic"] = ReactBasic;
  exports["SomethingElse"] = SomethingElse;
  exports["eqFramework"] = eqFramework;
  exports["showFramework"] = showFramework;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var classifyOverflow = function (str) {
      ...
      throw new Error("Failed pattern match at Ocelot.HTML.Properties (line 114, column 1 - line 116, column 12): " + [ str.constructor.name ]);
  };
  var classify = function (str) {
      ...
      throw new Error("Failed pattern match at Ocelot.HTML.Properties (line 83, column 1 - line 85, column 12): " + [ str.constructor.name ]);
  };
...
(function($PS) {
  ...
  var icon = function (className) {
      return function (iprops) {
          return Halogen_HTML_Elements.span([ Halogen_HTML_Properties_ARIA.label(className), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "inline-block" ])) ])([ Halogen_HTML_Elements.span(Ocelot_HTML_Properties.appendIProps(iprops)([ Halogen_HTML_Properties_ARIA.hidden("true"), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ className, "inline-block" ])) ]))([  ]) ]);
      };
  };                         
                  ...
                  return function (mkInput) {
                      return function (spec) {
                          var initialState = (function () {
                              var pipeline = Control_Semigroupoid.composeFlipped(Record_Builder.semigroupoidBuilder)(Record_Builder.modify()()({
                                  reflectSymbol: function () {
                                      return "search";
                                  }
                              })(Data_Symbol.SProxy.value)(Data_Maybe.fromMaybe("")))(Control_Semigroupoid.composeFlipped(Record_Builder.semigroupoidBuilder)(Record_Builder.modify()()({
                                  reflectSymbol: function () {
                                      return "debounceTime";
                                  }
                              })(Data_Symbol.SProxy.value)(Data_Maybe.fromMaybe(Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds))))(Control_Semigroupoid.composeFlipped(Record_Builder.semigroupoidBuilder)(Record_Builder.insert()()({
                                  reflectSymbol: function () {
                                      return "debounceRef";
                                  }
                              })(Data_Symbol.SProxy.value)(Data_Maybe.Nothing.value))(Control_Semigroupoid.composeFlipped(Record_Builder.semigroupoidBuilder)(Record_Builder.insert()()({
                                  reflectSymbol: function () {
                                      return "visibility";
                                  }
                              })(Data_Symbol.SProxy.value)(Off.value))(Record_Builder.insert()()({
                                  reflectSymbol: function () {
...
(function($PS) {
  ...
  var Web_HTML_Common = $PS["Web.HTML.Common"];                
  var ulClasses = Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "list-reset" ]);                                        
  var menuClasses = Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "bg-white", "text-black-20", "border", "list-reset", "rounded", "shadow", "absolute", "z-60", "min-w-50" ]);
  var liClasses = Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "px-4", "py-2", "rounded-sm", "text-black-20", "group", "hover:bg-grey-97", "cursor-pointer" ]);               
          ...
          return function (html) {
              return function (selected) {
                  return function (highlighted) {
                      ...
                      var checkmarkClass = Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "mr-2", "text-green" ]))((function () {
                          if (selected) {
                              return [  ];
                          };
                          return [ "invisible" ];
  ...
  var dropdownClasses = Data_Semigroup.append(Data_Semigroup.semigroupArray)(menuClasses)(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "absolute", "pin-t-full", "pin-l", "max-h-160", "overflow-y-auto" ]));
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Ocelot.Dropdown"] = $PS["Ocelot.Dropdown"] || {};
  var exports = $PS["Ocelot.Dropdown"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Control_Comonad = $PS["Control.Comonad"];
  ...
  var toggleProps = function (disabled) {
      return function (iprops) {
          var iprops$prime = Ocelot_HTML_Properties.appendIProps([ Halogen_HTML_Properties.disabled(disabled) ])(iprops);
          if (disabled) {
              return iprops$prime;
          };
          return Select_Setters.setToggleProps(iprops$prime);
      };
  };
      ...
      return function (v) {
          ...
          if (v instanceof SetSelection) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(new Data_Maybe.Just(v.value1))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $39.selectedItem = v.value0;
                  return $39;
              }));
          };
          throw new Error("Failed pattern match at Ocelot.Dropdown (line 211, column 23 - line 217, column 46): " + [ v.constructor.name ]);
      };
  };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  if (v2 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $47.visibility = Select.Off.value;
                          $47.selectedItem = new Data_Maybe.Just(v2.value0);
                          return $47;
                      }))(function () {
                          return Halogen_Query_HalogenM.raise(new Selected(v2.value0));
                      });
                  };
                  throw new Error("Failed pattern match at Ocelot.Dropdown (line 197, column 5 - line 204, column 38): " + [ v2.constructor.name ]);
              });
          };
      ...
      return function (button) {
          return function (props) {
              return function (toString) {
                  return function (label) {
                      return function (st) {
                          var toggle = Ocelot_Block_ItemContainer.dropdownButton(button)(toggleProps(st.disabled)(props))([ Halogen_HTML_Core.text(Data_Maybe.maybe(label)(toString)(st.selectedItem)) ]);
                          var containerClasses = (function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Dropdown (line 187, column 24 - line 189, column 22): " + [ st.visibility.constructor.name ]);
                          })();
                          var menu = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(containerClasses) ])([ Ocelot_Block_ItemContainer.dropdownContainer([  ])(function ($72) {
                              return Halogen_HTML_Core.text(toString($72));
                          })((function () {
                              var $73 = Data_Eq.eq(Data_Maybe.eqMaybe(dictEq))(st.selectedItem);
                              return function ($74) {
                                  return $73(Data_Maybe.Just.create($74));
                              };
  ...
  var _select = Type_Proxy["Proxy"].value;
  var handleQuery = function (v) {
      if (v instanceof SetDisabled) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(new Data_Maybe.Just(v.value1))(Halogen_Query.tell()({
              reflectSymbol: function () {
                  return "select";
              }
          })(Data_Ord.ordUnit)(_select)(Data_Unit.unit)((function () {
              var $75 = SetDisabled.create(v.value0);
              return function ($76) {
                  return Select.Query.create($75($76));
              };
          })()));
      };
      if (v instanceof SetItems) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(new Data_Maybe.Just(v.value1))(Halogen_Query.tell()({
              ...
              var $77 = SetItems.create(v.value0);
              return function ($78) {
                  return Select.Query.create($77($78));
              };
          })()));
      };
      if (v instanceof SetSelection) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(new Data_Maybe.Just(v.value1))(Halogen_Query.tell()({
              ...
              var $79 = SetSelection.create(v.value0);
              return function ($80) {
                  return Select.Query.create($79($80));
              };
          })()));
      };
      throw new Error("Failed pattern match at Ocelot.Dropdown (line 242, column 15 - line 248, column 67): " + [ v.constructor.name ]);
  };
  var renderAdapter = function (dictMonadAff) {
      return function (render) {
          return function (state) {
              ...
              })(Data_Ord.ordUnit)(_select)(Data_Unit.unit)(Select.component(dictMonadAff)()()()(Control_Category.identity(Control_Category.categoryFn))(spec(dictMonadAff)(render)))(embeddedInput(state))(PassingOutput.create);
          };
      };
  };
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Ocelot.Dropdown (line 234, column 16 - line 238, column 66): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["App.UI.FrameworkSelector.Component"] = $PS["App.UI.FrameworkSelector.Component"] || {};
  var exports = $PS["App.UI.FrameworkSelector.Component"];
  var App_Data_Types = $PS["App.Data.Types"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Function = $PS["Data.Function"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var Ocelot_Dropdown = $PS["Ocelot.Dropdown"];
  var Type_Proxy = $PS["Type.Proxy"];                
  ...
  var defaultState = {
      selectedFramework: Data_Maybe.Nothing.value
  };
  var _frameworkDropdown = Type_Proxy["Proxy"].value;
  var component = function (dictMonadAff) {
      var render = function (st) {
          var txt = (function () {
              if (st.selectedFramework instanceof Data_Maybe.Nothing) {
                  return "Select a PureScript frontend framework!";
              };
              if (st.selectedFramework instanceof Data_Maybe.Just) {
                  return "Let's use " + (Data_Show.show(App_Data_Types.showFramework)(st.selectedFramework.value0) + "!");
              };
              throw new Error("Failed pattern match at App.UI.FrameworkSelector.Component (line 87, column 15 - line 89, column 50): " + [ st.selectedFramework.constructor.name ]);
          })();
          var options = [ App_Data_Types.Halogen.value, App_Data_Types.React.value, App_Data_Types.ReactBasic.value, App_Data_Types.SomethingElse.value ];
          var dropdownInput = {
              disabled: false,
              items: options,
              render: Ocelot_Dropdown.defDropdown(App_Data_Types.eqFramework)(Ocelot_Block_Button.button)([  ])(Data_Show.show(App_Data_Types.showFramework))("Pick One"),
              selectedItem: Data_Maybe.Nothing.value
          };
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(txt), Halogen_HTML.slot()({
              reflectSymbol: function () {
                  return "frameworkDropdown";
              }
          })(Data_Ord.ordUnit)(_frameworkDropdown)(Data_Unit.unit)(Ocelot_Dropdown.component(dictMonadAff))(dropdownInput)(HandleDropdown.create) ]);
      };
      var handleAction = function (v) {
          if (v.value0 instanceof Ocelot_Dropdown.Selected) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $8.selectedFramework = new Data_Maybe.Just(v.value0.value0);
                  return $8;
              });
          };
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
      ...
      return Halogen_Component.mkComponent({
          initialState: Data_Function["const"](defaultState),
          render: render,
          "eval": Halogen_Component.mkEval({
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var App_UI_FrameworkSelector_Component = $PS["App.UI.FrameworkSelector.Component"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(App_UI_FrameworkSelector_Component.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();